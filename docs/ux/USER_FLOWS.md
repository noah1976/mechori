...
| PROPOSEDの主要ステップ | 「記録を残す」 → 車両確認 → お題を選ぶか自由に書く → 整備系なら作業した人・場所（DIY／お店・工場／不明） → 入力 → 写真（任意） → 見せる相手 → 保存 → 完了 |
| 迷いやすい分岐 | クイック／詳しいの選択、整備記録との違い、未確認Providerと工場公式情報の違い、公開範囲、写真だけの公開可否 |
