...
- **P-076 記録本文内の写真表示改善**: 実機QAでスマートフォン本文写真の幅不足を確認したため、モバイルを全幅表示、縦横比別の最大幅をPCだけに適用するよう再修正した。contentBlocks順と写真説明を維持する。再デプロイ後、人間QAでは縦・正方形・横長の写真が左右均等にコンテンツ幅いっぱいとなり、PC幅が維持されることを確認する。
