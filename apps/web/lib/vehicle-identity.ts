...
/**
 * Keeps the Garage's vehicle profile factual and stable for free-entry vehicles.
 * Missing specification fields are omitted rather than given a weaker fallback.
 */
